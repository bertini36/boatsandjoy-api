...
from boatsandjoy.availability.exceptions import (
    NoDayDefinitionDefined,
    NoAvailabilityForDay
)
from boatsandjoy.boats.api import api as boats_api
from boatsandjoy.boats.domain import Boat
from boatsandjoy.boats.exceptions import NoActiveBoat
from boatsandjoy.boats.requests import FilterBoatsRequest
from boatsandjoy.core.exceptions import BoatsAndJoyException
from boatsandjoy.core.responses import (
    ResponseBuilder,
